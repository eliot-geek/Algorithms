namespace _24_One_way_Circular_Linked_List_Delete
{
    internal class Program
    {
        ...
        /// <summary>
        /// Removes a node from the specified position in the one-way circular linked list.
        /// </summary>
        /// <param name="removePosition">The position of the node to be removed.</param>
